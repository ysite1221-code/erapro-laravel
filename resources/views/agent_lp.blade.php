...
<style>
    /* ヒーロー */
    .lp-hero { background:linear-gradient(135deg,#000e2c,#004e92); color:#fff; text-align:center; padding:100px 24px 90px; }
    ...
    .btn-lp-cta {
        display:inline-block; background:#fff; color:#004e92; font-weight:700;
    ...
    .btn-lp-cta:hover { background:#f0f4ff; transform:translateY(-2px); box-shadow:0 14px 40px rgba(0,0,0,0.22); }
    ...
    .merit-num  { font-size:0.75rem; font-weight:700; color:#004e92; letter-spacing:0.12em; margin-bottom:14px; display:block; }
    ...
    .plan-card.featured { border-color:#004e92; position:relative; }
    .plan-card.featured::before {
        content:'おすすめ'; position:absolute; top:-14px; left:50%; transform:translateX(-50%);
        background:#004e92; color:#fff; font-size:0.75rem; font-weight:700;
    ...
    .plan-price { font-size:2.4rem; font-weight:900; color:#004e92; line-height:1; margin-bottom:4px; }
    ...
    .plan-list li::before { content:'✓ '; color:#004e92; font-weight:700; }
    ...
    .step-num { width:48px; height:48px; border-radius:50%; background:#004e92; color:#fff; font-size:1.2rem; font-weight:900; display:flex; align-items:center; justify-content:center; margin:0 auto 16px; }
    ...
    .lp-cta-inner  { background:linear-gradient(135deg,#004e92,#000e2c); border-radius:8px; padding:64px 48px; text-align:center; color:#fff; }
