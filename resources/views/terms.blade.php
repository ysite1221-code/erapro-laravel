...
<div class="static-wrap">
    ...
    <p>本利用規約（以下「本規約」）は、ERAPRO（以下「当社」）が提供する保険Agentマッチングサービス「ERAPRO」（以下「本サービス」）の利用条件を定めるものです。ユーザーおよびAgentの皆様には、本規約に同意いただいた上でご利用いただきます。</p>
    ...
    <h2>第8条（メッセージ内容の確認と通信の秘密）</h2>
    <p>当社は、電気通信事業法その他の法令の定めに従い、通信の秘密を尊重します。ただし、以下のいずれかに該当する場合、当社は必要最小限の範囲でユーザー間のメッセージ内容を確認することがあります。</p>
    <ul>
        <li>本サービスの健全な運営を確保し、不正利用・詐欺・ハラスメント等のトラブルを防止するため</li>
        <li>法令または公的機関からの適法な要請に応じるため</li>
        <li>他のユーザーの生命・身体・財産の保護のため緊急性が認められる場合</li>
    </ul>
    <p>ユーザーは、本サービスを利用することにより、上記目的に基づくメッセージ内容の確認について同意したものとみなします。当社は、確認した情報を上記目的以外に利用しません。</p>

    <h2>第9条（個人情報の取り扱い）</h2>
    <p>当社は、本サービスの利用を通じて取得した個人情報を、別途定める「プライバシーポリシー」に従い適切に管理します。ユーザーは本規約に同意することにより、プライバシーポリシーの内容にも同意したものとします。</p>
